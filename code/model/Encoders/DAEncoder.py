...
class DAEncoder(nn.Module):
    def __init__(self, args, vocab, n_dim, image_dim, layers, dropout, num_choice=5):
        ...
        self.util = UtilityLayer(hidden_dim=300, feedforward_dim=1024, n_head=6, dropout=0.1)
        self.util2 = UtilityLayer(hidden_dim=300, feedforward_dim=1024, n_head=6, dropout=0.1)
        self.summary_s = SummaryAttn(300, 5, 0.1)
        self.summary_m = SummaryAttn(300, 5, 0.1)
        self.summary_b = SummaryAttn(300, 5, 0.1)
        self.summary_q = SummaryAttn(300, 5, 0.1)
        self.summary_addit = SummaryAttn(300, 5, 0.1)
    ...
    def forward(self, que, answers, **features):
        ...
        return S, M, B, Q, addit, concat_qa, q_c, e_ans, e_ans_list
